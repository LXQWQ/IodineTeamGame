        ...
        children: [z.jsx("a", {
            ...
            children: [z.jsxs("div", {
                ...
                children: [z.jsxs("div", {
                    ...
                    className: "px-3 pb-1",
                    children: [z.jsx("div", { className: "flex gap-1 mb-2", children: [z.jsx("button", { type: "button", onClick: function(){setModel("deepseek")}, className: ca("px-4 py-2 text-sm rounded-lg transition-colors font-semibold", model === "deepseek" ? "bg-emerald-500 text-white border border-emerald-400 shadow-lg" : "bg-zinc-700 text-zinc-200 border border-zinc-600 hover:bg-zinc-500 hover:text-white") }, "DS Flash"), z.jsx("button", { type: "button", onClick: function(){setModel("gemini")}, className: ca("px-4 py-2 text-sm rounded-lg transition-colors font-semibold", model === "gemini" ? "bg-emerald-500 text-white border border-emerald-400 shadow-lg" : "bg-zinc-700 text-zinc-200 border border-zinc-600 hover:bg-zinc-500 hover:text-white") }, "Gemini")] }), z.jsxs("form", {
                        onSubmit: ut,
