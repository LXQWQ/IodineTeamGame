        ...
        children: [z.jsx("a", {
            ...
            children: [z.jsxs("div", {
                ...
                children: [z.jsxs("div", {
                    ...
                    className: "px-3 pb-1",
                    children: [z.jsx("div", { className: "flex gap-1 mb-2" style: {flexWrap:"nowrap"}, children: [z.jsx("button", { type: "button", onClick: function(){setModel("deepseek")}, className: ca("px-2.5 py-1.5 text-xs rounded-lg transition-colors font-semibold", model === "deepseek" ? "bg-emerald-500 text-zinc-900 font-bold border border-emerald-500" : "bg-zinc-800 text-zinc-300 border border-zinc-700") }, "DS"), z.jsx("button", { type: "button", onClick: function(){setModel("gemini")}, className: ca("px-2.5 py-1.5 text-xs rounded-lg transition-colors font-semibold", model === "gemini" ? "bg-emerald-500 text-zinc-900 font-bold border border-emerald-500" : "bg-zinc-800 text-zinc-300 border border-zinc-700") }, "Gem")] }), z.jsxs("form", {
                        onSubmit: ut,
            ...
            children: [z.jsxs("div", {
                ...
                children: [z.jsxs("div", {
                    ...
                    children: [z.jsx("div", { className: "flex gap-1 mb-3" style: {flexWrap:"nowrap"}, children: [z.jsx("button", { type: "button", onClick: function(){setModel("deepseek")}, className: ca("px-2.5 py-1.5 text-xs rounded-lg transition-colors font-semibold", model === "deepseek" ? "bg-emerald-500 text-zinc-900 font-bold border border-emerald-500" : "bg-zinc-800 text-zinc-300 border border-zinc-700") }, "DS"), z.jsx("button", { type: "button", onClick: function(){setModel("gemini")}, className: ca("px-2.5 py-1.5 text-xs rounded-lg transition-colors font-semibold", model === "gemini" ? "bg-emerald-500 text-zinc-900 font-bold border border-emerald-500" : "bg-zinc-800 text-zinc-300 border border-zinc-700") }, "Gem")] }), z.jsxs("form", {
                        onSubmit: ut,
