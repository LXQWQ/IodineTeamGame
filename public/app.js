    document.addEventListener('DOMContentLoaded', () => {
        ...
        // ======================= 游戏展示 =======================
            ...
            { id:8, name:"CChO 考纲可视化", emoji:"📊", tag:"竞赛考纲 v6", desc:"CChO 中国化学奥林匹克基本要求交互式知识图谱（v6 · 2024 修订版）！共 95 项考点 · 8 大类，覆盖 2014–2026 共 283 道国初真题，原题图片与答案解析完整收录，按考点分类浏览、串联考纲—真题—教材。附使用指南与更新日志——备考化竞的必备工具。", link:"氢队游戏/考纲可视化/", newWindow:true },
